...
function createPetalTooltip(index, rarityIndex) {
    ...
    if (tier.spawnable !== undefined) {
        ...
        text("- Health: " + formatLargeNumber(+state.mobConfigs[tier.spawnable.index].tiers[tier.spawnable.rarity].health), 20, newY + 17.5, 15, colors.common, ctx);
        text("- Damage: " + formatLargeNumber(+state.mobConfigs[tier.spawnable.index].tiers[tier.spawnable.rarity].damage), 20, newY + 17.5 * 2, 15, mixColors(colors.legendary, "#FFFFFF", .2), ctx);
